...
/**
 * This is a generic logger class for use in logging. This can easily be swapped
 * out for any other logging package in the main code. For now, this is just a
 * quick and dirty logger which will allow you to specify log levels, but only
